...
HD_PWD='/home/franco/CLP/Recursos/CESE_CLP_TPFINAL/fp_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_multiplier_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fp_multiplier_VIO.tcl -notrace
