...
HD_PWD='/home/franco/CLP/Recursos/CESE_CLP_TPFINAL/fp_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_multiplier_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_multiplier_VIO.tcl
